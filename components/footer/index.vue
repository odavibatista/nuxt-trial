<script setup>
    const styles = {
        ...
        top: {
            ...
            input: "bg-zinc-200 w-72 p-2 px-4 text-zinc-600",
...
<template>
    <footer :class="styles.footer">
        <div :class="styles.top.div">
            <div :class="styles.top.left">
                ...
                <span :class="styles.top.span">
                    <input type="text" :class="styles.top.input" placeholder="Your e-mail here...">
            ...
            <div :class="styles.top.right">
                ...
                <div :class="styles.top.socialLinks">
                    <a href="https://www.facebook.com">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" :class="styles.icons" viewBox="0 0 16 16">
        ...
        <div :class="styles.bottom">
            ...
            <p :class="styles.p">
                Daniels' steaks is a fictional butcher house created by odavibatista. None of this site's images belong to me, and are meant uniquely for educational use.
            </p>
